                ...
                <nav class="sb-sidenav accordion bg-secondary" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav" style="text-align: center;">
                            ...
                            <a class="nav-link" href="adminPostReply.jsp" style="color: rgb(224, 179, 57);">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="title_tab"><a href="admin_post_reply.html" style="text-decoration: none; color: black;">댓글</a> | <a href="admin_post_blog.html" style="text-decoration: none; color: black;">블로그</a> | <a href="admin_post_event.html" style="text-decoration: none; color: rgb(224, 179, 57);">이벤트</a></h1>
                        <br><br>
                        <div class="card mb-4">
