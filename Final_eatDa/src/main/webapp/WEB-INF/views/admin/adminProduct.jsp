                ...
                <nav class="sb-sidenav accordion bg-secondary" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav" style="text-align: center;">
                            ...
                            <a class="nav-link" href="adminProduct.jsp" style="color: rgb(224, 179, 57);">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img src="assets/img/P1.png" style="width: 20%; height: 20%;"></td>
                                            <td>즉석 떡볶이(2인분)</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="chk"></td>
                                            <td><a href=""><img src="assets/img/P2.png" style="width: 20%; height: 20%;"></a></td>
                                            <td>오뎅식당 X 부대찌개</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="chk"></td>
                                            <td><a href=""><img src="assets/img/P3.png" style="width: 20%; height: 20%;"></a></td>
                                            <td>샤브샤브 (2인분)</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="chk"></td>
                                            <td><a href=""><img src="assets/img/P4.png" style="width: 20%; height: 20%;"></a></td>
                                            <td>제육볶음(3팩)</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="chk"></td>
                                            <td><a href=""><img src="assets/img/P5.png" style="width: 20%; height: 20%;"></a></td>
                                            <td>덮밥 (1인분)</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="chk"></td>
                                            <td><a href=""><img src="assets/img/P1.png" style="width: 20%; height: 20%;"></a></td>
                                            <td>즉석 떡볶이(2인분)</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="chk"></td>
